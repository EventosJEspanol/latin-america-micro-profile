...
* link:.platform.app.yaml[`.platform.app.yaml`]: Controlamos la aplicación y la forma en la que se construye y despliega en Platform.sh https://docs.platform.sh/configuration/app-containers.html[via un único archivo de configuración].
